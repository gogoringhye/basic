...
tabMenu.find('ul>li>a').click(function (e) {
    ...
    $(this).parent('li').addClass('active').siblings('li').removeClass('active').find('ul').hide(); /* 위 세줄을 줄인 내용과 동일 */
...
$('.ad').click(function () {
    //$('.layer-bg').show();
    //$('layer-bg').slideDown();/* slideDown은 아무것도 안적어도 0.3초를 가지고 있음 */
    $('.layer-bg').fadeIn(); /* 대소문자 구분 */
});
